...
include(currentpath+'chrome-plugin/js/DigitalAssistantSDK.js','end');
// include('chrome-plugin/js/links.js');
// import '/lib/load.js';
// import '/chrome-plugin/js/links.js';
/*
window.addEventListener('DOMContentLoaded', (event) => {
	// include('chrome-plugin/js/DigitalAssistantSDK.js','end');
	// import('/chrome-plugin/js/DigitalAssistantSDK.js');
});
*/
